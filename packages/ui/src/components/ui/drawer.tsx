import type { Inertia, PanInfo } from "framer-motion";
...
const DrawerHeader = ({
  ...
  <DialogHeader className={cn("pt-2", className)} {...props} />
);
...
const DrawerBody = ({
  ...
  <DialogBody {...props} className={cn("px-4", className)}>
    {children}
  </DialogBody>
);
...
const DrawerFooter = ({
  ...
  <DialogFooter {...props} className={cn("pb-2", className)}>
    {children}
  </DialogFooter>
);
